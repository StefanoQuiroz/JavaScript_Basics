...
// console.log(fibonacci(3), fibonacci(4), fibonacci(5), fibonacci(6), fibonacci(7));
...
function secondBig(numArr){
    var max=numArr[0], min=0;
    if(numArr.length === 0) return null;
...
//console.log(secondBig([42,1,4,3.14,7]));
...
function doubleTroublePair(numArr){
    var newArr = [];
    for(var i=0; i<numArr.length; i++){
...
//console.log(doubleTroublePair([4, "Ulysses", 42, false]));